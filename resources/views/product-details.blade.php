            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="product-wrapper product-style-2 slide-4 p-0 light-arrow bottom-space">
                        @foreach ($slide_products as $slide)
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{ route('product.details',$slide->slug) }}">
                                            <img src="{{ asset('assets/images/fashion/product/front/'.$slide->image) }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="{{ route('product.details',$slide->slug) }}">
                                            <img src="{{ asset('assets/images/fashion/product/back/'.$slide->image) }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{ route('product.details',$slide->slug) }}" class="font-default">
                                            <h5>{{ $slide->name }}</h5>
                                        </a>
                                        <div class="listing-content">
                                            <span class="font-light">{{ $slide->category->name }}</span>
                                            <p class="font-light">{{ $slide->short_description }}
                                        </div>

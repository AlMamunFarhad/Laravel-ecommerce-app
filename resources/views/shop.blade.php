                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{ $brand->id }}"
                                                            name="brands" onchange="brandProductFilter(this)"
                                                            @if (in_array($brand->id, explode(',', $brand_checkbox))) checked="checked" @endif
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it"
                                                            ...
                                                            value="{{ $category->id }}"
                                                            onchange="categoryFilterProduct(this);">
                                                        <label class="form-check-label"
                                                            for="ct{{ $category->id }}">{{ $category->name }}</label>

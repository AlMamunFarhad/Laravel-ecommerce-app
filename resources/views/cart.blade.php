...
@section('content')
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="removeCartItem('{{ $item->rowId }}')">
                                                <i class="fas fa-times"></i>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="row">
                            <div class="col-sm-7 col-5 order-1">
                                <div class="left-side-button text-end d-flex d-block justify-content-end">
                                    <a href="javascript:void(0)"
                                        class="text-decoration-underline theme-color d-block text-capitalize" onclick="clearCart()">clear
                                        all items</a>
                                </div>
                            </div>
            ...
            @else
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="{{ route('shop.index') }}" class="mt-4 btn btn-warning rounded">Shop Now</a>
                    </div>
                </div>
            @endif
        </div>
    ...
    <form action="{{ route('cart.remove') }}" method="POST" id="removeCart">
        @csrf
        @method('DELETE')
